  ...
  return (
    ...
    >
      ...
      <PortalToFollowElemContent className="z-[999]">
        <div className={classNames('relative px-3 py-2 text-xs font-normal text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 rounded-md shadow-lg', className)}>
          {htmlContent ?? content}
          {arrow}
        </div>
