const translation = {
  ...
  auth: {
    ...
    setupModalTitleDescription: '配置憑證後，工作區中的所有成員都可以在編排應用程式時使用此工具。',
  },
  ...
  createTool: {
    ...
    privacyPolicy: '隱私政策',
    privacyPolicyPlaceholder: '請輸入隱私政策',
  },
  thought: {
    using: '正在使用',
    used: '已使用',
  ...
  noCustomTool: {
    title: '沒有自訂工具！',
    content: '在此統一新增和管理你的自訂工具，方便建構應用程式時使用。',
    createTool: '建立工具',
  },
  noSearchRes: {
    title: '抱歉，沒有結果！',
    content: '我們找不到任何與您的搜尋相符合的工具。',
    reset: '重設搜尋',
  },
